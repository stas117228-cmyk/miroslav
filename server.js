...
io.on('connection', socket => {
    ...
    socket.on('joinRoom', ({ nickname, roomId }) => {
        // Создаём комнату, если её ещё нет
        ...
        // Если вопрос уже идёт, отправляем текущий вопрос и таймер новому игроку
